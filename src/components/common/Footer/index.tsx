    ...
    <footer className="w-content max-w-full mx-auto py-8 text-zinc-300 mt-auto">
      <div className="grid place-items-center gap-y-2 w-full">
        <div className="flex flex-wrap justify-center">
          ...
          <a
            className="text-fox w-10 h-10 grid place-items-center rounded-md hover:bg-zinc-700"
            href="https://twitter.com/intent/follow?screen_name=nickelsh1ts"
            rel="noopener noreferrer"
            target="_blank"
          ...
          <a
            className="text-fox w-10 h-10 grid place-items-center rounded-md hover:bg-zinc-700"
            href="https://front-end.social/@nickelsh1ts"
            rel="noopener noreferrer"
            target="_blank"
          ...
          <a
            className="text-fox w-10 h-10 grid place-items-center rounded-md hover:bg-zinc-700"
            href="https://codepen.io/nickelsh1ts"
            rel="noopener noreferrer"
            target="_blank"
          ...
          <a
            className="text-fox w-10 h-10 grid place-items-center rounded-md hover:bg-zinc-700"
            href="https://twitch.tv/nickelsh1ts"
            rel="noopener noreferrer"
            target="_blank"
