      ...
      <div className="w-content max-w-full mv-0 mx-auto grid gap-0 px-4">
        <div className="relative flex justify-end items-center min-h-half-avatar py-2 my-2">
          ...
          <a
            ...
            className="hover:no-underline border-transparent focus:border-white outline-transparent focus-visible:border-white hover:border-white border-4 rounded-full text-fluid--1 flex gap-x-1 items-center text-white bg-fox px-3 py-1"
          >
        ...
        {/* <form className="my-6 grid gap-y-2 justify-center text-center">
          ...
          <div className="flex">
            <input
              ...
              type="email"
            />
            <button className="font-bold hover:no-underline border-transparent focus:border-white outline-transparent focus-visible:border-white hover:border-white border-4 rounded-r-full text-fluid--1 flex gap-x-1 items-center text-white bg-fox px-3 py-1">
              Request!
            </button>
          </div>
